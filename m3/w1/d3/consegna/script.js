...
var Tasse = /** @class */ (function () {
    ...
    Tasse.prototype.getTasseIrpef = function () {
        ...
        if (this.redditoAnnuoLordo > 15000 && this.redditoAnnuoLordo <= 28000) {
            return IrpefPagata2;
        }
        if (this.redditoAnnuoLordo > 28000 && this.redditoAnnuoLordo <= 50000) {
            return IrpefPagata3;
        }
        if (this.redditoAnnuoLordo > 50000) {
            return IrpefPagata4;
        }
    };
    return Tasse;
